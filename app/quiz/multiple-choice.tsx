...
import { ChevronRight, Award, HelpCircle } from 'lucide-react-native';
...
export default function MultipleChoiceScreen() {
  ...
  const createQuizQuestions = (words: Word[]): QuizQuestion[] => {
    ...
    const quizWords = shuffledWords.slice(0, 10); // 10 questions for multiple choice
  ...
  if (quizComplete) {
    ...
    return (
      <SafeAreaView style={[styles.container, { backgroundColor: themeColors.background }]} edges={['bottom']}>
        <Stack.Screen options={{ title: 'Multiple Choice Quiz' }} />
